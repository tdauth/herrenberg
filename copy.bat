copy "C:\Users\Tamino\Games\Age of Empires 2 DE\76561197992163765\resources\_common\scenario\[COOP] Herrenberg.aoe2scenario" "C:\Users\Tamino\Documents\Projekte\herrenberg\resources\_common\scenario"
...
zip -r -p "[COOP] Herrenberg.zip" "resources" "info.json" "thumbnail.jpg"
pause
